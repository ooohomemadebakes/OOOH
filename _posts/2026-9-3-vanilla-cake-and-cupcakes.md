...
* 1 cup (8oz, 227mL) whole milk, buttermilk, or unsweetened milk alternative (such as almond)  
    Or 1 cup (8 oz, 227mL) full-fat sour cream + 3 Tablespoon water  use same amounts plain yogurt + water  
...
![Rectangle pan with parchment](<img src="{{ '/assets/img/rectangular-pan-with-parchment.jpg' | relative_url }}" class=)  
...
**A metal pan is best. Glass and ceramic conduct heat more slowly than metals (the center will take longer to bake fully). If glass/ceramic is all that is available, increase the baking time anywhere from 5-10 minutes.  
